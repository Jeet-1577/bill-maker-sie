...
def home(request):
    features = [
        {
            ...
            "description": "Generate professional bills instantly with customizable templates, tax calculations, and split billing options.",
        ...
        },
        {
            ...
            "description": "Track ingredients, manage stock levels, and get automated alerts for low inventory. Reduce waste and optimize costs.",
    ...
    return render(request, "hello/index.html", {"features": features})
